...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        ...
        #     abort(400, message="A tag with that name already exists in that store.") #Not needed as unique name already there
...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An error occured while iserting the tag.")
